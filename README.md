...
Teremos uma introdução ~~muito~~ breve sobre JavaScript, que é a linguagem utilizada no mundo web e portanto a linguagem que Phaser foi escrita e nela veremos o básico da sintaxe da linguagem. Também veremos como criar um localhost para rodar seu jogasso na apresentação do Phaser.
...
Por fim usaremos a base que o próprio [Phaser](https://docs.phaser.io/) disponibiliza e a mais básica de [JS](https://developer.mozilla.org/pt-BR/docs/Web/JavaScript)
...
## Autores
- [Rafael Pioto Gomes](https://github.com/piotogomes)
